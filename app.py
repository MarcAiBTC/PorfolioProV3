...
def help_page_enhanced():
    ...
    try:
        ...
        st.warning("**Disclaimer**: This app is for informational purposes only. Not financialst.warning("**Disclaimer**: This app is for informational purposes only. Not financial advice.")
